module Partner
  ...
  class TripWaypointsController < ApplicationController
    ...
    def create
      ...
      respond_to do |format|
        if @trip_waypoint.save
          format.html { redirect_to partner_trip_path(params[:trip_id]), notice: "Le lieu a été ajouté à l'itinéraire" }
    ...
    def destroy
      ...
      respond_to do |format|
        format.html { redirect_to partner_trip_path(@trip[:id]), notice: 'Le lieu a été retiré de cet itinéraire.' }
